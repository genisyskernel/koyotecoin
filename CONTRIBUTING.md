...
`#koyotecoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#koyotecoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/koyotecoin-core-dev/](https://www.erisian.com.au/koyotecoin-core-dev/)
and [https://gnusha.org/koyotecoin-core-dev/](https://gnusha.org/koyotecoin-core-dev/).
...
For GUI-related issues or pull requests, the https://github.com/koyotecoin-core/gui repository should be used.
...
https://github.com/koyotecoin/koyotecoin/pull/16189).

Also see the [backport.py script](
https://github.com/koyotecoin-core/koyotecoin-maintainer-tools#backport).
