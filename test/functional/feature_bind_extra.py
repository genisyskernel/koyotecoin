...
"""
Test starting koyotecoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(KoyotecoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that koyotecoind has bound on "::1" (for RPC) and "::" (for P2P).
