...
class FullBlockTest(KoyotecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.send_blocks([b16], success=False,
        ...
        self.send_blocks(
            [b17], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        self.send_blocks(
            [b19], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        self.send_blocks(
            [b20], success=False, reject_reason='bad-txns-premature-spend-of-coinbase', reconnect=True)
        ...
        self.send_blocks(
            [b22], success=False, reject_reason='bad-txns-premature-spend-of-coinbase', reconnect=True)
        ...
        self.send_blocks([b24], success=False,
                         reject_reason='bad-blk-length', reconnect=True)
        ...
        # Extend the b26 chain to make sure koyotecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure koyotecoind isn't accepting b28
        ...
        self.send_blocks([b32], success=False,
                         reject_reason='bad-blk-sigops', reconnect=True)
        ...
        self.send_blocks([b34], success=False,
                         reject_reason='bad-blk-sigops', reconnect=True)
        ...
        self.send_blocks([b36], success=False,
                         reject_reason='bad-blk-sigops', reconnect=True)
        ...
        self.send_blocks(
            [b37], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)

        # attempt to spend b37's first non-coinbase tx, at which point b37 was still considered valid
        self.move_tip(35)
        b38 = self.next_block(38, spend=txout_b37)
        self.send_blocks(
            [b38], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        # Create a transaction that spends one howloshi to the p2sh_script, the rest to OP_TRUE
        ...
        # Until block is full, add tx's with 1 howloshi to p2sh_script, the rest to OP_TRUE
        tx_new = None
        tx_last = tx
        ...
        self.send_blocks([b40], success=False,
                         reject_reason='bad-blk-sigops', reconnect=True)
        ...
        while b47.sha256 <= target:
            ...
            b47.nNonce += 1
            b47.rehash()
        self.send_blocks([b47], False, force_send=True,
                         reject_reason='high-hash', reconnect=True)
        ...
        b50.solve()
        self.send_blocks([b50], False, force_send=True,
                         reject_reason='bad-diffbits', reconnect=True)
        ...
        self.send_blocks([b51], success=False,
                         reject_reason='bad-cb-multiple', reconnect=True)
        ...
        self.send_blocks([b54], False, force_send=True,
                         reject_reason='time-too-old', reconnect=True)
        ...
        tx.vin.append(
            CTxIn(COutPoint(out[17].sha256, 42), CScript([OP_TRUE]), SEQUENCE_FINAL))
        tx.vout.append(CTxOut(0, b""))
        tx.calc_sha256()
        b58 = self.update_block(58, [tx])
        self.send_blocks(
            [b58], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        assert_equal(self.nodes[0].gettxout(
            txid=duplicate_tx.hash, n=0)['confirmations'], 119)
        self.send_blocks([b_spend_dup_cb, b_dup_2], success=True)
        # The duplicate has less confirmations
        assert_equal(self.nodes[0].gettxout(
            txid=duplicate_tx.hash, n=0)['confirmations'], 1)
        ...
        self.send_blocks([b62], success=False,
                         reject_reason='bad-txns-nonfinal', reconnect=True)
        ...
        # koyotecoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        self.send_blocks(
            [b66], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        self.send_blocks(
            [b67], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        #                        \-> b68 (20)
        #
        # b68 - coinbase with an extra 10 howloshis,
        #       creates a tx that has 9 howloshis from out[20] go to fees
        #       this fails because the coinbase is trying to claim 1 howloshi too much in fees
        #
        # b69 - coinbase with extra 10 howloshis, and a tx that gives a 10 howloshi fee
        #       this succeeds
        #
        self.log.info(
        ...
        tx = CTransaction()
        tx.vin.append(
            CTxIn(COutPoint(bogus_tx.sha256, 0), b"", SEQUENCE_FINAL))
        tx.vout.append(CTxOut(1, b""))
        b70 = self.update_block(70, [tx])
        self.send_blocks(
            [b70], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        self.send_blocks([b73], success=False,
                         reject_reason='bad-blk-sigops', reconnect=True)
        ...
        self.send_blocks([b74], success=False,
                         reject_reason='bad-blk-sigops', reconnect=True)
        ...
        #    Low-S and High-S values (whereas the koyotecoin code has custom code which does so);
        ...
        self.send_blocks(
            [b89a], success=False, reject_reason='bad-txns-inputs-missingorspent', reconnect=True)
        ...
        self.send_blocks([b_v1], success=False, force_send=True,
                         reject_reason='bad-version(0x00000001)', reconnect=True)
        ...
        b_cb34.solve()
        self.send_blocks([b_cb34], success=False,
                         reject_reason='bad-cb-height', reconnect=True)
    ...
    def next_block(self, number, spend=None, additional_coinbase_value=0, script=CScript([OP_TRUE]), *, version=4):
        ...
        if spend is None:
            ...
            coinbase.vout[0].nValue += spend.vout[0].nValue - \
                1  # all but one howloshi to fees
            coinbase.rehash()
            tx = self.create_tx(spend, 0, 1, script)  # spend 1 howloshi
            self.sign_tx(tx, spend)
            tx.rehash()
            block = create_block(base_block_hash, coinbase,
                                 block_time, version=version, txlist=[tx])
