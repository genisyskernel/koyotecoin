...
"""Verify that starting koyotecoin with -h works as expected."""

from test_framework.test_framework import KoyotecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KoyotecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start koyotecoin with -h for help text")
        ...
        self.log.info("Start koyotecoin with -version for version information")
        ...
        self.log.info("Start koyotecoind with -fakearg to make sure it does not start")
