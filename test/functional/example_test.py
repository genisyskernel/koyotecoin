...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KoyotecoinTestFramework
    pass


class ExampleTest(KoyotecoinTestFramework):
    # Each functional test is a subclass of the KoyotecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        KoyotecoinTestFramework class so other tests can use it."""
