...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/koyotecoin/koyotecoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(KoyotecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our koyotecoind node")
