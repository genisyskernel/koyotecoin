...
class WalletCrossChain(KoyotecoinTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].koyotecoinconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].koyotecoinconf, 'w', encoding='utf8') as conf:
