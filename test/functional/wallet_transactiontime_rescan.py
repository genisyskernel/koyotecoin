...
class TransactionTimeRescanTest(KoyotecoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine KYC and create transactions
        ...
        # generate some kyc to create transactions and check blockcount
        ...
        # send 10 kyc to user's first watch-only address
        self.log.info('Send 10 kyc to user')
        ...
        # send 5 kyc to our second watch-only address
        self.log.info('Send 5 kyc to user')
        ...
        # send 1 kyc to our third watch-only address
        self.log.info('Send 1 kyc to user')
