...
class TxnMallTest(KoyotecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 KYC:
        ...
        # First: use raw transaction API to send 1240 KYC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KYC coin each
        ...
        # Node0's balance should be starting balance, plus 50KYC for another
        ...
        # Node0's total balance should be starting balance, plus 100KYC for
