...
This file is modified from python-koyotecoinlib.
"""
...
def bn2vch(v):
    """Convert number to koyotecoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Howloshi codebase"""
    r = b''
