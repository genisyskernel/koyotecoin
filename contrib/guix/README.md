# Bootstrappable Koyotecoin Core Builds

This directory contains the files necessary to perform bootstrappable Koyotecoin
Core builds.
...
```
env DETACHED_SIGS_REPO=<path/to/koyotecoin-detached-sigs> ./contrib/guix/guix-codesign
```
