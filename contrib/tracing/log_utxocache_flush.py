...
"""Example logging Koyotecoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/koyotecoind
...
def main(koyotecoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[koyotecoind_with_usdts])
