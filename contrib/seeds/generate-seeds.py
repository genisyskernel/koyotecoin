...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef KOYOTECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define KOYOTECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the koyotecoin network\n')
    ...
    g.write('#endif // KOYOTECOIN_CHAINPARAMSSEEDS_H\n')
