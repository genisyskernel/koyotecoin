...
libs = [
    'libkoyotecoin_cli',
    'libkoyotecoin_common',
    'libkoyotecoin_crypto',
    'libkoyotecoin_node',
    'libkoyotecoin_util',
    'libkoyotecoin_wallet_tool',
    'libkoyotecoin_wallet',
    'libkoyotecoin_zmq',
    'bench_koyotecoin',
    'libtest_util',
]
...
def parse_config_into_kyc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Koyotecoin Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/koyotecoin_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/koyotecoin_config.h'), "w", encoding="utf8") as kyc_config:
        kyc_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='Koyotecoin-core msbuild configuration initialiser.')
    ...
    parse_config_into_kyc_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/koyotecoin_config.h'), os.path.join(SOURCE_DIR, 'config/koyotecoin-config.h'))
