...
This document provides guidelines for internationalization of the Koyotecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `koyotecoin_en.ts` remains unchanged.
