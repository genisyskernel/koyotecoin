...
To assist in updating translations, a helper script is available in the [maintainer-tools repo](https://github.com/koyotecoin-core/koyotecoin-maintainer-tools). To use it and commit the result, simply do:
