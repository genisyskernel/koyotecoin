Koyotecoin Core version 0.11.1 is now available from:

  <https://koyotecoin.org/bin/koyotecoin-core-0.11.1/>
...
one was randomly violated by all deployed koyotecoin software prior to
...
Koyotecoin Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Koyotecoinj has done so for a similar span of time.
...
[1] On the Malleability of Koyotecoin Transactions
...
(see https://github.com/koyotecoin/koyotecoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libkoyotecoinconsensus: avoid a crash in multi-threaded environments
