...
defaults to 0.00001. This will cause transactions with fewer KYC/kB fee to be
...
- #6269 `95aca44` gitian: Use the new koyotecoin-detached-sigs git repo for OSX signatures
...
- #5729 `9c4a5a5` Allow unit changes for read-only KoyotecoinAmountField
- #5753 `0f44672` Add koyotecoin logo to about screen
...
- #5809 `46bfbe7` Add koyotecoin-cli man page
...
- #5849 `41259ca` contrib/init/koyotecoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Koyotecoin-Qt.app to Koyotecoin-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for koyotecoin-tx)
