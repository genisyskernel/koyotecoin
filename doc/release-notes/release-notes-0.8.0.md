Koyotecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/koyotecoin/files/Koyotecoin/koyotecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Koyotecoin
...
New/changed settings (command-line or koyotecoin.conf file)
--------------------------------------------------------
