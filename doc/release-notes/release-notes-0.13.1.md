...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Koyotecoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Koyotecoin.
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  Other Koyotecoin community members are studying several other improvements
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.koyotecoinstats.com (TheBlueMatt, cdecker)
...
- #8829 `2a8bca4` Add koyotecoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` koyotecoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_koyotecoinds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update koyotecoin-tx to output witness data (jnewbery)
