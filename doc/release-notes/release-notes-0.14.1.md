Koyotecoin Core version 0.14.1 is now available from:

  <https://koyotecoin.org/bin/koyotecoin-core-0.14.1/>
...
here:
[reducing-koyotecoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10126 `0b5e162` Compenhowle for memory peak at flush time (sipa)
...
- #10130 `ecc5232` koyotecoin-tx input verification (awemany, jnewbery)
