...
Koyotecoin Core now has more flexibility in where the wallets directory can be
located. Previously wallet database files were stored at the top level of the
koyotecoin data directory. The behavior is now:
...
- #11970 `b7450cd` Add test coverage for koyotecoin-cli multiwallet calls (ryanofsky)
...
- #12035 `eeb6d52` Change µKYC to bits (jb55)
...
- #11621 `1f7695b` [build] Add temp_koyotecoin_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11297 `16e4184` Make sure ~/.koyotecoin doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for koyotecoin-config.h (danra)
...
- #10529 `331352f` Improve koyotecoind systemd service file (Flowdalic)
