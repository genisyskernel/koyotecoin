Koyotecoin Core version 0.9.2.1 is now available from:

  https://koyotecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KYC to 0.01 KYC
...
- Fix "Start koyotecoin on system login"
