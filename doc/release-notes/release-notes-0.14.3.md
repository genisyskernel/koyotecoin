Koyotecoin Core version *0.14.3* is now available from:

  <https://koyotecoin.org/bin/koyotecoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/koyotecoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
