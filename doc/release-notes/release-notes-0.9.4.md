Koyotecoin Core version 0.9.4 is now available from:

  https://koyotecoin.org/bin/0.9.4/
...
this update is incompatible with the Koyotecoin system and could lead to consensus
forks.

Koyotecoin Core released binaries from https://koyotecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~koyotecoin/+archive/ubuntu/koyotecoin
- A third-party or self-compiled Koyotecoin Core

upgrade to Koyotecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
