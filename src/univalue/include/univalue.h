...
// Copyright 2015 Koyotecoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef KOYOTECOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define KOYOTECOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // KOYOTECOIN_UNIVALUE_INCLUDE_UNIVALUE_H
