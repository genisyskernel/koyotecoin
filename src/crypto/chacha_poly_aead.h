...
#ifndef KOYOTECOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define KOYOTECOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@koyotecoin.
 *
 ...
 *
 * The chacha20-poly1305@koyotecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@koyotecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@koyotecoin are relatively fast in
...
#endif // KOYOTECOIN_CRYPTO_CHACHA_POLY_AEAD_H
