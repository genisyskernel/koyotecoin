...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.koyotecoin.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.koyotecoin.dashjr.org."); // Luke Dashjr
        vSeeds.emplace_back("seed.koyotecoinstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.koyotecoin.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.kyc.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.koyotecoin.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.koyotecoin.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.koyotecoin.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tkyc.petertodd.org.");
        vSeeds.emplace_back("seed.testnet.koyotecoin.sprovoost.nl.");
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("seed.signet.koyotecoin.sprovoost.nl.");
