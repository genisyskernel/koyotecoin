...
//! Entry point for KoyotecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &KoyotecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for KoyotecoinGUI tests.
void AppTests::guiTests(KoyotecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &KoyotecoinGUI::consoleShown, this, &AppTests::consoleTests);
