...
#ifndef KOYOTECOIN_QT_GUIUTIL_H
#define KOYOTECOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Koyotecoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "koyotecoin:" URI into recipient object, return true on successful parsing
