...
#ifndef KOYOTECOIN_NODE_CONNECTION_TYPES_H
#define KOYOTECOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/koyotecoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Koyotecoin’s Peer-to-Peer Network")
...
#endif // KOYOTECOIN_NODE_CONNECTION_TYPES_H
