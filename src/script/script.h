...
#ifndef KOYOTECOIN_SCRIPT_SCRIPT_H
#define KOYOTECOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Koyotecoin always counted CHECKMULTISIGs
...
#endif // KOYOTECOIN_SCRIPT_SCRIPT_H
