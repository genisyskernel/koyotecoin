...
#ifndef KOYOTECOIN_SCRIPT_STANDARD_H
#define KOYOTECOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a koyotecoin address
 */
...
/**
 * Generate a Koyotecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // KOYOTECOIN_SCRIPT_STANDARD_H
