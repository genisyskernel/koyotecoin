...
#ifndef KOYOTECOIN_INTERFACES_NODE_H
#define KOYOTECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a koyotecoin node (koyotecoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or koyotecoin.conf.
...
#endif // KOYOTECOIN_INTERFACES_NODE_H
