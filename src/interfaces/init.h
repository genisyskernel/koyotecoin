...
#ifndef KOYOTECOIN_INTERFACES_INIT_H
#define KOYOTECOIN_INTERFACES_INIT_H
...
//! (koyotecoin-gui, koyotecoin-node, koyotecoin-wallet, koyotecoind, koyotecoin-qt) and each
...
#endif // KOYOTECOIN_INTERFACES_INIT_H
