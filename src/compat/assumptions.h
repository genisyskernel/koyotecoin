...
#ifndef KOYOTECOIN_COMPAT_ASSUMPTIONS_H
#define KOYOTECOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Koyotecoin cannot be compiled without assertions."
#endif
...
#endif // KOYOTECOIN_COMPAT_ASSUMPTIONS_H
