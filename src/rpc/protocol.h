...
#ifndef KOYOTECOIN_RPC_PROTOCOL_H
#define KOYOTECOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in koyotecoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Koyotecoin is not connected
...
#endif // KOYOTECOIN_RPC_PROTOCOL_H
