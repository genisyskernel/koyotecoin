...
#ifndef KOYOTECOIN_CLIENTVERSION_H
#define KOYOTECOIN_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by koyotecoin-config.h or in any other way
#endif
...
#endif // KOYOTECOIN_CLIENTVERSION_H
